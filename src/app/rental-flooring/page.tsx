...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://modularcarpet.com.au/rental-flooring" },
  openGraph: {
    title: "Carpet Tiles for Rental Properties | DIY Rental Flooring",
    ...
    url: "https://modularcarpet.com.au/rental-flooring",
  ...
  return (
    <>
      <BreadcrumbJsonLd items={[
        ...
        { name: "Rental Properties", url: "https://modularcarpet.com.au/rental-flooring" },
      ]} />
