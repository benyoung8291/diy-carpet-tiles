...
Modular Carpet, lift the damaged tile and swap in a fresh one in 60 seconds.

### Fade-Resistant Nylon
Solution-dyed nylon locks colour in at a molecular level. Perfect for
sun-drenched Australian living rooms - no fading, no colour loss, year after
year.

### Safe Over Concrete Slabs
Traditional carpet traps moisture and breeds mould. Our breathable recycled
PET felt backing lets your concrete slab breathe - solving the #1 carpet
problem in Australian homes.

### Built-In Acoustic Underlay
No separate underlay to buy or install. The bonded felt backing delivers 0.25
...
### [Horizon](https://www.modularcarpet.com.au/ranges/horizon)
...
- Tile dimensions: 500 x 1000 mm
- Thickness: 11 mm (+-10%)
- Pile fibre: Solution-dyed nylon
- Backing: Breathable recycled PET felt
- Acoustic rating: 0.25 NRC
...
- Brand: Modular Carpet by Premrest
- Legal entity: Premier Restorations Group Pty Ltd
- Address: 1/99 Heyington Ave, Thomastown, VIC 3074, Australia
- Phone: 1300 207 915
...
- [Site map](https://www.modularcarpet.com.au/sitemap.xml)
- [API catalog](https://www.modularcarpet.com.au/.well-known/api-catalog)
- [Robots policy](https://www.modularcarpet.com.au/robots.txt)
`;
